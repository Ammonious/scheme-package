...
// 是否需要锁定在maxChildSize，在下拉加载更多的时候需要锁定在maxChildSize
typedef ShouldLockAtTop = bool Function();
...
class _DraggableScrollableSheetState extends State<SchemeDraggableSheet> with TickerProviderStateMixin {
