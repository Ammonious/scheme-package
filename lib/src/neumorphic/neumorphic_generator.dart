...
typedef NMGenerator = BoxDecoration Function(Color base, {Color accent, NMTheme style});
          ...
          ? LinearGradient(
              ...
              colors: [
                style.shape == NMShape.flat
                    ? base
                    : colorGen(base, style.shape == NMShape.convex ? 0.07 : -0.1),
                style.shape == NMShape.flat
                    ? base
                    : colorGen(base, style.shape == NMShape.convex ? -0.1 : 0.07),
              ],
            )
          : null,
      boxShadow: [
