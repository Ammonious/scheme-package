...
class SuperRevealChip extends StatefulWidget {
	...
	@override
	_SuperRevealChipState createState() => _SuperRevealChipState();
}

class _SuperRevealChipState extends State<SuperRevealChip> {
