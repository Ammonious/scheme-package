...
class BubbleTabIndicator extends Decoration {
	...
	const BubbleTabIndicator( {this.brandColor,
...
class _BubblePainter extends BoxPainter {
	...
	Color get indicatorColor => decoration.indicatorColor ?? Colors.blueAccent;
	...
	void paint(Canvas canvas, Offset offset, ImageConfiguration configuration) {
		...
		LinearGradient gradient = schemeGradient(colorOne: indicatorColor,colorTwo: indicatorColor.shade900);

		Path path = Path();
		path.addOval(indicator);
		Paint gradientSplash = Paint()..shader = gradient.createShader(rect);
		canvas.drawShadow(path, indicatorColor.withOpacity(0.9) ,  8.0, false);
